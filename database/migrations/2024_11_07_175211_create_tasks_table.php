...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tasks', function (Blueprint $table) {
            ...
            $table->foreignId('project_id')->references('id')->on('projects')->constrained()->cascadeOnUpdate()->cascadeOnDelete();
            $table->foreignId('assigned_user_id')->nullable()->references('id')->on('users')->constrained()->cascadeOnUpdate()->cascadeOnDelete();
