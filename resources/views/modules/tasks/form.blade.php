<form action="{{ $action }}" method="POST" enctype="multipart/form-data">
    ...
    @endif
    @if ($method === 'PATCH')
        <input type="hidden" name="created_by" id="created_by" value="{{ $task->created_by }}">
    ...
    <div class="flex gap-4 mt-4">
        ...
        <div class="w-full mt-4">
            ...
            <input
                ...
                id="name" name="name" type="text" value="{{ old('name', $task->name) }}" required>
    ...
    <div class="flex gap-4 mt-4">
        ...
        <div class="w-full mt-4">
            ...
            <select
                class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                name="status_id" id="status_id" value="{{ old('status_id', $task?->status_id) }}" required>
        ...
        <div class="w-full mt-4">
            ...
            <select
                class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                name="priority_id" id="priority_id" value="{{ old('priority_id', $task?->priority_id) }}" required>
