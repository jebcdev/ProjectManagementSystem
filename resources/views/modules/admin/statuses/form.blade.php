...
<form action="{{ $action }}" method="POST">
    ...
    <div class="mt-4">
        ...
        <input
            ...
            id="name" name="name" type="text" value="{{ old('name', $status->name) }}" required>
   ...
   <div class="flex justify-between gap-2">
    <div class="mt-4 w-1/2">
        ...
        <input
            class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
            id="description" name="description" type="text" value="{{ old('name', $status->description) }}" required>
    ...
    <div class="mt-4 w-1/2">
        ...
        <input
            class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
            id="color" name="color" type="color" value="{{ old('name', $status->color) }}" required>
