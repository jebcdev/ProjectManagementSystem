...
<?php endif; ?>
        <input
            ...
            id="name" name="name" type="text" value="<?php echo e(old('name', $priority->name)); ?>" required>
...
<?php endif; ?>
        <input
            class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
            id="description" name="description" type="text" value="<?php echo e(old('name', $priority->description)); ?>" required>
        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
        <input
            class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
            id="color" name="color" type="color" value="<?php echo e(old('name', $priority->color)); ?>" required>
...
<?php /**PATH D:\laragon\www\ProjectManagementSystem\resources\views\modules\admin\priorities\form.blade.php ENDPATH**/ ?>