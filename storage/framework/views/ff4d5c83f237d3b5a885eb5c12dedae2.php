    ...
    <div class="mt-2 mb-4 text-center">
        <form action="<?php echo e(route($route)); ?>">
            <div class="border-white rounded-full p-2">
                ...
                <input
                    ...
                    type="text" id="search" name="search" value="<?php echo e(request('search')); ?>" />
...
<?php endif; ?>
                ...
                <?php if($totalResults != null): ?>
                    <span class="ml-5 text-gray-700 dark:text-gray-400">
                        <?php echo e(__('Total Results')); ?>: <?php echo e($totalResults); ?>
...
<?php /**PATH D:\laragon\www\ProjectManagementSystem\resources\views/helpers/search-header.blade.php ENDPATH**/ ?>