        ...
        <div class="mx-auto sm:px-4 lg:px-4">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900 dark:text-gray-100">
                    ...
                    <div>
                        <?php if ($__env->exists('modules.admin.users.form', [
                            'action' => route('admin.users.store'),
                            'method' => 'POST',
                        ])) echo $__env->make('modules.admin.users.form', [
                            'action' => route('admin.users.store'),
                            'method' => 'POST',
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\ProjectManagementSystem\resources\views\modules\admin\users\create.blade.php ENDPATH**/ ?>